namespace Hylo.Serialization.Json.Utilities;
...
public static class JsonStrategicMergePatch
{
    ...
    /// <param name="patchConfiguration">An object used to configure the <see cref="StrategicMergePatch"/></param>
    ...
    {
        if (patch == null) return target;
        if (patchConfiguration == null) patchConfiguration = JsonSerializer.Deserialize<Configuration>(patch);
    ...
    {
        if (patch == null) return target;
        if (patchConfiguration == null) try { patchConfiguration = JsonSerializer.Deserialize<Configuration>(patch); } catch { }
        ...
        switch (patchConfiguration?.Strategy)
        {
            ...
            default:
                ...
                foreach (var itemPatch in patch)
                {
                    ...
                    {
                        patchConfiguration = JsonSerializer.Deserialize<Configuration>(objectPatch);
                        switch (patchConfiguration?.Strategy)
                        {
    ...
    /// <summary>
    /// Represents an object used to configure a <see cref="StrategicMergePatch"/>
    /// </summary>
    [DataContract]
    ...
    /// <summary>
    /// Enumerates all supported <see cref="StrategicMergePatch"/> strategies
    /// </summary>
    public static class Strategies
    {
        ...
        /// <summary>
        /// Gets all supported <see cref="StrategicMergePatch"/> strategies
        /// </summary>
        /// <returns>A new <see cref="IEnumerable{T}"/> containing all supported <see cref="StrategicMergePatch"/> strategies</returns>
    ...
    /// <summary>
    /// Enumerates all supported <see cref="StrategicMergePatch"/> directives
    /// </summary>
    public static class Directives
    {
        ...
        /// <summary>
        /// Gets all supported <see cref="StrategicMergePatch"/> directives
        /// </summary>
        /// <returns>A new <see cref="IEnumerable{T}"/> containing all supported <see cref="StrategicMergePatch"/> directives</returns>
        public static IEnumerable<string> AsEnumerable()
        {
            yield return Patch;
