    ...
    : PathAssemblyResolver
{
    ...
    /// <inheritdoc/>
    public PluginPathAssemblyResolver(IEnumerable<string> assemblyPaths, IEnumerable<string> pluginAssemblyPaths)
        : base(assemblyPaths)
    {
        this.PluginAssemblyResolver = new(pluginAssemblyPaths);
    }
