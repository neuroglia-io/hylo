...
/// </summary>
[DataContract]
public class V1ResourceAdmissionEvaluationResult
{

    /// <summary>
    /// Initializes a new <see cref="V1ResourceAdmissionEvaluationResult"/>
    /// </summary>
    public V1ResourceAdmissionEvaluationResult() { }
    ...
    public V1ResourceAdmissionEvaluationResult(bool succeeded, V1Patch? patch = null, IEnumerable<V1Error>? errors = null)
    {
