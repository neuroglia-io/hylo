...
public interface IIdentityRoleManager
{
    ...
    /// <summary>
    /// Retrieves all the <see cref="V1Role"/>s assigned to the specified identity
    /// </summary>
    /// <param name="subject">The subject to list the <see cref="V1Role"/>s of</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken"/></param>
    /// <returns>An <see cref="IEnumerable{T}"/> containing the names of the <see cref="V1Role"/> assigned to the specified identity</returns>
