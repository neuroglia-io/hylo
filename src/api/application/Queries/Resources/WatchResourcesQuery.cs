...
/// </summary>
public class WatchResourcesQueryHandler
    : ResourceRequestHandlerBase, IQueryHandler<WatchResourcesQuery, IResourceWatch>
{
    ...
    /// <inheritdoc/>
    public virtual async Task<ApiResponse<IResourceWatch>> Handle(WatchResourcesQuery query, CancellationToken cancellationToken)
    {
        return this.Ok(await this.Repository.WatchAsync(query.Group, query.Version, query.Plural, query.Namespace, query.LabelSelectors, cancellationToken).ConfigureAwait(false));
    }
